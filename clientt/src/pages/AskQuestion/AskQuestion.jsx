        ...
        <div className='ask-ques-container'>
          ...
          <form onSubmit={handleSubmit}>
            <div className='ask-form-container'>
                ...
                person</p>
                <input
                type="text"  id="ask-ques-title" onChange={(e) => {setQuestionTitle(e.target.value)}} placeholder='e.g. Is there an R function for finding the index of an element in a vector?'/>
                     </label>
               ...
               <textarea name="" id="ask-ques-body"  onChange={(e) =>{setQuestionBody(e.target.value)}}
                ...
                <input
                type="text"  id="ask-ques-tags" onChange={(e) => {setQuestionTags(e.target.value.split(" "))}} placeholder="e.g. (xml typescript wordpress)"   />
                     </label></div>
                     <input
            type="submit"
